...
if user_id == "abc" and user_password == '1234':
    ...
    st.sidebar.header("Project 101")
    selectbox_options = ['환율조회','데이터 분석', '머신러닝'] # 셀렉트 박스의 선택 항목
    your_option = st.sidebar.selectbox('Menu?', selectbox_options) # 셀렉트박스의 항목 선택 결과 index=0제거함.
