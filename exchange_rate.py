...
#컴안에 텍스트외의 엑셀, 이미지...는 binary형식으로 저장되기때문에 binary로 저장
def ex_rate():
    ...
    if clicked:
        ...
        ax.set_ylabel("원화/{current_name}", fontsize = 10)
        plt.xticks(fontsize=10)  #눈금값의 폰트 크기 
    ...
    #     pass
        ...
        #dataframe 데이터를 csv 데이터 변환
        csv_data = df_exchange_rate.to_csv()

        #dataframe데이터를 엑셀 데이터 변환
